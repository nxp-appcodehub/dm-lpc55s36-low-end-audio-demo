...
typedef enum _inputmux_connection_t
{
    ...
    /*!< AOI trigger. */
    kINPUTMUX_PinInt0ToAoiInTrigger         = 0U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_PinInt1ToAoiInTrigger         = 1U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_SctOut0ToAoiInTrigger         = 2U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_SctOut1ToAoiInTrigger         = 3U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_SctOut2ToAoiInTrigger         = 4U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_SctOut3ToAoiInTrigger         = 5U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer0M3ToAoiInTrigger       = 6U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer1M3ToAoiInTrigger       = 7U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer2M3ToAoiInTrigger       = 8U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer2M2ToAoiInTrigger       = 9U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer3M2ToAoiInTrigger       = 10U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Ctimer4M2ToAoiInTrigger       = 11U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_CompOutToAoiInTrigger         = 12U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_GpiointBmatchToAoiInTrigger   = 13U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc0IrqToAoiInTrigger         = 14U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc1IrqToAoiInTrigger         = 15U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc0Tcomp0ToAoiInTrigger      = 16U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc0Tcomp1ToAoiInTrigger      = 17U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc0Tcomp2ToAoiInTrigger      = 18U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc0Tcomp3ToAoiInTrigger      = 19U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc1Tcomp0ToAoiInTrigger      = 20U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc1Tcomp1ToAoiInTrigger      = 21U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc1Tcomp2ToAoiInTrigger      = 22U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Adc1Tcomp3ToAoiInTrigger      = 23U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Hscmp0OutToAoiInTrigger       = 24U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Hscmp1OutToAoiInTrigger       = 25U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Hscmp2OutToAoiInTrigger       = 26U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm0MuxTrig0ToAoiInTrigger = 27U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm0MuxTrig1ToAoiInTrigger = 28U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm1MuxTrig0ToAoiInTrigger = 29U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm1MuxTrig1ToAoiInTrigger = 30U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm2MuxTrig0ToAoiInTrigger = 31U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm2MuxTrig1ToAoiInTrigger = 32U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm3MuxTrig0ToAoiInTrigger = 33U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm0Sm3MuxTrig1ToAoiInTrigger = 34U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm0MuxTrig0ToAoiInTrigger = 35U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm0MuxTrig1ToAoiInTrigger = 36U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm1MuxTrig0ToAoiInTrigger = 37U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm1MuxTrig1ToAoiInTrigger = 38U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm2MuxTrig0ToAoiInTrigger = 39U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm2MuxTrig1ToAoiInTrigger = 40U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm3MuxTrig0ToAoiInTrigger = 41U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm3MuxTrig1ToAoiInTrigger = 42U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Enc0CmpPosMatchToAoiInTrigger = 43U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Enc1CmpPosMatchToAoiInTrigger = 44U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_ExtTrigIn0ToAoiInTrigger      = 45U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_ExtTrigIn1ToAoiInTrigger      = 46U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_ExtTrigIn2ToAoiInTrigger      = 47U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_ExtTrigIn3ToAoiInTrigger      = 48U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout0ToAoiInTrigger    = 51U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout1ToAoiInTrigger    = 52U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout2ToAoiInTrigger    = 53U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout3ToAoiInTrigger    = 54U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout4ToAoiInTrigger    = 55U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout5ToAoiInTrigger    = 56U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma0Trigout6ToAoiInTrigger    = 57U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma1Trigout0ToAoiInTrigger    = 58U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma1Trigout1ToAoiInTrigger    = 59U + (AOI0_IN0 << PMUX_SHIFT),
    kINPUTMUX_Dma1Trigout2ToAoiInTrigger    = 60U + (AOI0_IN0 << PMUX_SHIFT),
