 ...
 */
// TODO :: :: all 3 DCDC_POWER_PROFILE_* constants below to be updated after chip characterization on ATE
...
#define DCDC_POWER_PROFILE_MEDIUM_MAX_FREQ_HZ \
    (130000000UL) /* Maximum System Frequency allowed with DCDC Power Profile MEDIUM */
 ...
 */
// TODO :: :: all 3 PROCESS_* constants below to be updated after chip characterization on ATE
#define PROCESS_NNN_AVG_HZ (19300000UL) /* Average Ring Oscillator value for Nominal (NNN) Manufacturing Process */
#define PROCESS_NNN_STD_HZ \
    (400000UL) /* Standard Deviation Ring Oscillator value for Nominal (NNN) Manufacturing Process */
#define PROCESS_NNN_LIMITS \
    (6UL) /* Nominal (NNN) Manufacturing Process Ring Oscillator values limit (with respect to the Average value) */
...
// TODO :: :: all 9 VOLTAGE_* constants below to be updated after chip characterization on ATE
#define VOLTAGE_SSS_LOW_MV (1075UL) /* Voltage Settings for : Process=SSS, DCDC Power Profile=LOW */
#define VOLTAGE_SSS_MED_MV (1150UL) /* Voltage Settings for : Process=SSS, DCDC Power Profile=MEDIUM */
#define VOLTAGE_SSS_HIG_MV (1200UL) /* Voltage Settings for : Process=SSS, DCDC Power Profile=HIGH */

#define VOLTAGE_NNN_LOW_MV (1000UL) /* Voltage Settings for : Process=NNN, DCDC Power Profile=LOW */
...
#define VOLTAGE_FFF_LOW_MV (1000UL) /* Voltage Settings for : Process=FFF, DCDC Power Profile=LOW */
#define VOLTAGE_FFF_MED_MV (1025UL) /* Voltage Settings for : Process=FFF, DCDC Power Profile=MEDIUM */
#define VOLTAGE_FFF_HIG_MV (1050UL) /* Voltage Settings for : Process=FFF, DCDC Power Profile=HIGH */
