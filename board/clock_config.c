...
sources:
- {id: ANACTRL.fro_hf.outFreq, value: 96 MHz}
- {id: SYSCON.XTAL.outFreq, value: 16 MHz, enabled: true}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
outputs:
- {id: DAC0_clock.outFreq, value: 125 kHz}
- {id: FRO_12MHz_clock.outFreq, value: 12 MHz}
...
- {id: ENABLE_CLKIN_ENA, value: Enabled}
- {id: ENABLE_SYSTEM_CLK_OUT, value: Enabled}
- {id: SYSCON.DAC0CLKDIV.scale, value: '8', locked: true}
- {id: SYSCON.DAC0CLKSEL.sel, value: SYSCON.fro_1m}
- {id: SYSCON.MAINCLKSELB.sel, value: SYSCON.PLL0_BYPASS}
- {id: SYSCON.PLL0CLKSEL.sel, value: SYSCON.CLK_IN_EN}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U, false);         /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivDac0Clk, 0U, true);            /*!< Reset DAC0CLKDIV divider counter and halt it */
    CLOCK_SetClkDiv(kCLOCK_DivDac0Clk, 8U, false);           /*!< Set DAC0CLKDIV divider to value 8 */

    /*!< Set up clock selectors - Attach clocks to the peripheries */
    CLOCK_AttachClk(kPLL0_to_MAIN_CLK);                 /*!< Switch MAIN_CLK to PLL0 */
    CLOCK_AttachClk(kFRO1M_to_DAC0);                 /*!< Switch DAC0 to FRO1M */
